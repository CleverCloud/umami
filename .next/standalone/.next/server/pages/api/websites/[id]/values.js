...
/* harmony import */ var private_next_pages_api_websites_id_values_ts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(49856);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([private_next_pages_api_websites_id_values_ts__WEBPACK_IMPORTED_MODULE_3__]);
private_next_pages_api_websites_id_values_ts__WEBPACK_IMPORTED_MODULE_3__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__)[0];
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,next_dist_build_webpack_loaders_next_route_loader_helpers__WEBPACK_IMPORTED_MODULE_2__/* .hoist */ .l)(private_next_pages_api_websites_id_values_ts__WEBPACK_IMPORTED_MODULE_3__, "default"));
// Re-export config.
const config = (0,next_dist_build_webpack_loaders_next_route_loader_helpers__WEBPACK_IMPORTED_MODULE_2__/* .hoist */ .l)(private_next_pages_api_websites_id_values_ts__WEBPACK_IMPORTED_MODULE_3__, "config");
// Create and export the route module that will be consumed.
const routeModule = new PagesAPIRouteModule({
    definition: {
        kind: next_dist_server_future_route_kind__WEBPACK_IMPORTED_MODULE_1__/* .RouteKind */ .x.PAGES_API,
        page: "/api/websites/[id]/values",
        pathname: "/api/websites/[id]/values",
        // The following aren't used in production.
        bundlePath: "",
        filename: ""
    },
    userland: private_next_pages_api_websites_id_values_ts__WEBPACK_IMPORTED_MODULE_3__
});
...
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([lib_auth__WEBPACK_IMPORTED_MODULE_0__, lib_middleware__WEBPACK_IMPORTED_MODULE_1__, queries__WEBPACK_IMPORTED_MODULE_4__]);
([lib_auth__WEBPACK_IMPORTED_MODULE_0__, lib_middleware__WEBPACK_IMPORTED_MODULE_1__, queries__WEBPACK_IMPORTED_MODULE_4__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (async (req, res)=>{
    ...
    if (req.method === "GET") {
        if (!lib_constants__WEBPACK_IMPORTED_MODULE_3__/* .SESSION_COLUMNS */ .H1.includes(type) && !lib_constants__WEBPACK_IMPORTED_MODULE_3__/* .EVENT_COLUMNS */ .vh.includes(type)) {
            return (0,next_basics__WEBPACK_IMPORTED_MODULE_2__.badRequest)(res);
        }
        ...
        const values = await (0,queries__WEBPACK_IMPORTED_MODULE_4__/* .getValues */ .KX)(websiteId, lib_constants__WEBPACK_IMPORTED_MODULE_3__/* .FILTER_COLUMNS */ .MI[type]);
        return (0,next_basics__WEBPACK_IMPORTED_MODULE_2__.ok)(res, values.map(({ value })=>value).filter((n)=>n).sort());
    }
...
var __webpack_exports__ = __webpack_require__.X(0, [172,5510,4531], () => (__webpack_exec__(99713)));
