...
/* harmony import */ var private_next_pages_api_teams_id_websites_index_ts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(54254);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([private_next_pages_api_teams_id_websites_index_ts__WEBPACK_IMPORTED_MODULE_3__]);
private_next_pages_api_teams_id_websites_index_ts__WEBPACK_IMPORTED_MODULE_3__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__)[0];
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,next_dist_build_webpack_loaders_next_route_loader_helpers__WEBPACK_IMPORTED_MODULE_2__/* .hoist */ .l)(private_next_pages_api_teams_id_websites_index_ts__WEBPACK_IMPORTED_MODULE_3__, "default"));
// Re-export config.
const config = (0,next_dist_build_webpack_loaders_next_route_loader_helpers__WEBPACK_IMPORTED_MODULE_2__/* .hoist */ .l)(private_next_pages_api_teams_id_websites_index_ts__WEBPACK_IMPORTED_MODULE_3__, "config");
// Create and export the route module that will be consumed.
const routeModule = new PagesAPIRouteModule({
    definition: {
        kind: next_dist_server_future_route_kind__WEBPACK_IMPORTED_MODULE_1__/* .RouteKind */ .x.PAGES_API,
        page: "/api/teams/[id]/websites",
        pathname: "/api/teams/[id]/websites",
        // The following aren't used in production.
        bundlePath: "",
        filename: ""
    },
    userland: private_next_pages_api_teams_id_websites_index_ts__WEBPACK_IMPORTED_MODULE_3__
});
...
/* harmony import */ var lib_yup__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(87789);
...
/* harmony import */ var queries_admin_teamWebsite__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(21403);
/* harmony import */ var yup__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(75609);
/* harmony import */ var yup__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(yup__WEBPACK_IMPORTED_MODULE_6__);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([lib_auth__WEBPACK_IMPORTED_MODULE_0__, lib_middleware__WEBPACK_IMPORTED_MODULE_1__, queries__WEBPACK_IMPORTED_MODULE_4__, queries_admin_teamWebsite__WEBPACK_IMPORTED_MODULE_5__]);
([lib_auth__WEBPACK_IMPORTED_MODULE_0__, lib_middleware__WEBPACK_IMPORTED_MODULE_1__, queries__WEBPACK_IMPORTED_MODULE_4__, queries_admin_teamWebsite__WEBPACK_IMPORTED_MODULE_5__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
const schema = {
    GET: yup__WEBPACK_IMPORTED_MODULE_6__.object().shape({
        ...
        ...(0,lib_yup__WEBPACK_IMPORTED_MODULE_2__/* .getFilterValidation */ .W)(/All|Name|Domain/i)
    }),
    POST: yup__WEBPACK_IMPORTED_MODULE_6__.object().shape({
        id: yup__WEBPACK_IMPORTED_MODULE_6__.string().uuid().required(),
        websiteIds: yup__WEBPACK_IMPORTED_MODULE_6__.array().of(yup__WEBPACK_IMPORTED_MODULE_6__.string()).min(1).required()
    })
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (async (req, res)=>{
    ...
    if (req.method === "GET") {
        if (!await (0,lib_auth__WEBPACK_IMPORTED_MODULE_0__/* .canViewTeam */ .q9)(req.auth, teamId)) {
            return (0,next_basics__WEBPACK_IMPORTED_MODULE_3__.unauthorized)(res);
        }
        const { page, filter, pageSize } = req.query;
        const websites = await (0,queries__WEBPACK_IMPORTED_MODULE_4__/* .getWebsitesByTeamId */ .w)(teamId, {
            page,
            filter,
            pageSize: +pageSize || null
        });
        return (0,next_basics__WEBPACK_IMPORTED_MODULE_3__.ok)(res, websites);
    }
    if (req.method === "POST") {
        if (!await (0,lib_auth__WEBPACK_IMPORTED_MODULE_0__/* .canViewTeam */ .q9)(req.auth, teamId)) {
            return (0,next_basics__WEBPACK_IMPORTED_MODULE_3__.unauthorized)(res);
        ...
        const websites = await (0,queries_admin_teamWebsite__WEBPACK_IMPORTED_MODULE_5__/* .createTeamWebsites */ .Rx)(teamId, websiteIds);
        return (0,next_basics__WEBPACK_IMPORTED_MODULE_3__.ok)(res, websites);
    }
...
var __webpack_exports__ = __webpack_require__.X(0, [172,5510,4531], () => (__webpack_exec__(37947)));
