...
/* harmony import */ var private_next_pages_api_teams_id_websites_websiteId_ts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(20440);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([private_next_pages_api_teams_id_websites_websiteId_ts__WEBPACK_IMPORTED_MODULE_3__]);
private_next_pages_api_teams_id_websites_websiteId_ts__WEBPACK_IMPORTED_MODULE_3__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__)[0];
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,next_dist_build_webpack_loaders_next_route_loader_helpers__WEBPACK_IMPORTED_MODULE_2__/* .hoist */ .l)(private_next_pages_api_teams_id_websites_websiteId_ts__WEBPACK_IMPORTED_MODULE_3__, "default"));
// Re-export config.
const config = (0,next_dist_build_webpack_loaders_next_route_loader_helpers__WEBPACK_IMPORTED_MODULE_2__/* .hoist */ .l)(private_next_pages_api_teams_id_websites_websiteId_ts__WEBPACK_IMPORTED_MODULE_3__, "config");
// Create and export the route module that will be consumed.
const routeModule = new PagesAPIRouteModule({
    definition: {
        kind: next_dist_server_future_route_kind__WEBPACK_IMPORTED_MODULE_1__/* .RouteKind */ .x.PAGES_API,
        page: "/api/teams/[id]/websites/[websiteId]",
        pathname: "/api/teams/[id]/websites/[websiteId]",
        // The following aren't used in production.
        bundlePath: "",
        filename: ""
    },
    userland: private_next_pages_api_teams_id_websites_websiteId_ts__WEBPACK_IMPORTED_MODULE_3__
});
...
/* harmony import */ var queries_admin_teamWebsite__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(21403);
/* harmony import */ var yup__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(75609);
/* harmony import */ var yup__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(yup__WEBPACK_IMPORTED_MODULE_4__);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([lib_auth__WEBPACK_IMPORTED_MODULE_0__, lib_middleware__WEBPACK_IMPORTED_MODULE_1__, queries_admin_teamWebsite__WEBPACK_IMPORTED_MODULE_3__]);
([lib_auth__WEBPACK_IMPORTED_MODULE_0__, lib_middleware__WEBPACK_IMPORTED_MODULE_1__, queries_admin_teamWebsite__WEBPACK_IMPORTED_MODULE_3__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (async (req, res)=>{
    ...
    if (req.method === "DELETE") {
        if (!await (0,lib_auth__WEBPACK_IMPORTED_MODULE_0__/* .canDeleteTeamWebsite */ .oy)(req.auth, teamId, websiteId)) {
            return (0,next_basics__WEBPACK_IMPORTED_MODULE_2__.unauthorized)(res);
        }
        await (0,queries_admin_teamWebsite__WEBPACK_IMPORTED_MODULE_3__/* .deleteTeamWebsite */ .Vr)(teamId, websiteId);
...
var __webpack_exports__ = __webpack_require__.X(0, [172,5510,4531], () => (__webpack_exec__(8383)));
