...
/* harmony import */ var private_next_pages_api_event_data_stats_ts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(92438);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([private_next_pages_api_event_data_stats_ts__WEBPACK_IMPORTED_MODULE_3__]);
private_next_pages_api_event_data_stats_ts__WEBPACK_IMPORTED_MODULE_3__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__)[0];
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,next_dist_build_webpack_loaders_next_route_loader_helpers__WEBPACK_IMPORTED_MODULE_2__/* .hoist */ .l)(private_next_pages_api_event_data_stats_ts__WEBPACK_IMPORTED_MODULE_3__, "default"));
// Re-export config.
const config = (0,next_dist_build_webpack_loaders_next_route_loader_helpers__WEBPACK_IMPORTED_MODULE_2__/* .hoist */ .l)(private_next_pages_api_event_data_stats_ts__WEBPACK_IMPORTED_MODULE_3__, "config");
// Create and export the route module that will be consumed.
const routeModule = new PagesAPIRouteModule({
    definition: {
        kind: next_dist_server_future_route_kind__WEBPACK_IMPORTED_MODULE_1__/* .RouteKind */ .x.PAGES_API,
        page: "/api/event-data/stats",
        pathname: "/api/event-data/stats",
        // The following aren't used in production.
        bundlePath: "",
        filename: ""
    },
    userland: private_next_pages_api_event_data_stats_ts__WEBPACK_IMPORTED_MODULE_3__
});
...
/* harmony import */ var queries_index__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(37451);
/* harmony import */ var yup__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(75609);
/* harmony import */ var yup__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(yup__WEBPACK_IMPORTED_MODULE_4__);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([lib_auth__WEBPACK_IMPORTED_MODULE_0__, lib_middleware__WEBPACK_IMPORTED_MODULE_1__, queries_index__WEBPACK_IMPORTED_MODULE_3__]);
([lib_auth__WEBPACK_IMPORTED_MODULE_0__, lib_middleware__WEBPACK_IMPORTED_MODULE_1__, queries_index__WEBPACK_IMPORTED_MODULE_3__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
const schema = {
    GET: yup__WEBPACK_IMPORTED_MODULE_4__.object().shape({
        ...
        startAt: yup__WEBPACK_IMPORTED_MODULE_4__.number().integer().required(),
        endAt: yup__WEBPACK_IMPORTED_MODULE_4__.number().integer().moreThan(yup__WEBPACK_IMPORTED_MODULE_4__.ref("startAt")).required()
    })
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (async (req, res)=>{
    ...
    if (req.method === "GET") {
        ...
        const data = await (0,queries_index__WEBPACK_IMPORTED_MODULE_3__/* .getEventDataStats */ .CG)(websiteId, {
            startDate,
            endDate
        });
...
var __webpack_exports__ = __webpack_require__.X(0, [172,5510,4531], () => (__webpack_exec__(59628)));
