...
/* harmony import */ var private_next_pages_api_auth_logout_ts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(53361);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([private_next_pages_api_auth_logout_ts__WEBPACK_IMPORTED_MODULE_3__]);
private_next_pages_api_auth_logout_ts__WEBPACK_IMPORTED_MODULE_3__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__)[0];
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,next_dist_build_webpack_loaders_next_route_loader_helpers__WEBPACK_IMPORTED_MODULE_2__/* .hoist */ .l)(private_next_pages_api_auth_logout_ts__WEBPACK_IMPORTED_MODULE_3__, "default"));
// Re-export config.
const config = (0,next_dist_build_webpack_loaders_next_route_loader_helpers__WEBPACK_IMPORTED_MODULE_2__/* .hoist */ .l)(private_next_pages_api_auth_logout_ts__WEBPACK_IMPORTED_MODULE_3__, "config");
...
const routeModule = new PagesAPIRouteModule({
    ...
    userland: private_next_pages_api_auth_logout_ts__WEBPACK_IMPORTED_MODULE_3__
});
...
/* harmony import */ var _umami_redis_client__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(86505);
/* harmony import */ var _umami_redis_client__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_umami_redis_client__WEBPACK_IMPORTED_MODULE_1__);
...
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([lib_middleware__WEBPACK_IMPORTED_MODULE_2__, lib_auth__WEBPACK_IMPORTED_MODULE_3__]);
([lib_middleware__WEBPACK_IMPORTED_MODULE_2__, lib_auth__WEBPACK_IMPORTED_MODULE_3__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (async (req, res)=>{
    ...
    if (req.method === "POST") {
        if ((_umami_redis_client__WEBPACK_IMPORTED_MODULE_1___default().enabled)) {
            await _umami_redis_client__WEBPACK_IMPORTED_MODULE_1___default().del((0,lib_auth__WEBPACK_IMPORTED_MODULE_3__/* .getAuthToken */ .bW)(req));
        }
...
var __webpack_exports__ = __webpack_require__.X(0, [172,5510,4531], () => (__webpack_exec__(92949)));
