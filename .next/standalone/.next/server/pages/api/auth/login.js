...
/* harmony import */ var private_next_pages_api_auth_login_ts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(83200);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([private_next_pages_api_auth_login_ts__WEBPACK_IMPORTED_MODULE_3__]);
private_next_pages_api_auth_login_ts__WEBPACK_IMPORTED_MODULE_3__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__)[0];
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,next_dist_build_webpack_loaders_next_route_loader_helpers__WEBPACK_IMPORTED_MODULE_2__/* .hoist */ .l)(private_next_pages_api_auth_login_ts__WEBPACK_IMPORTED_MODULE_3__, "default"));
// Re-export config.
const config = (0,next_dist_build_webpack_loaders_next_route_loader_helpers__WEBPACK_IMPORTED_MODULE_2__/* .hoist */ .l)(private_next_pages_api_auth_login_ts__WEBPACK_IMPORTED_MODULE_3__, "config");
...
const routeModule = new PagesAPIRouteModule({
    ...
    userland: private_next_pages_api_auth_login_ts__WEBPACK_IMPORTED_MODULE_3__
});
...
/* harmony import */ var lib_middleware__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(24531);
...
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([lib_auth__WEBPACK_IMPORTED_MODULE_2__, lib_crypto__WEBPACK_IMPORTED_MODULE_3__, lib_middleware__WEBPACK_IMPORTED_MODULE_4__, queries__WEBPACK_IMPORTED_MODULE_6__]);
([lib_auth__WEBPACK_IMPORTED_MODULE_2__, lib_crypto__WEBPACK_IMPORTED_MODULE_3__, lib_middleware__WEBPACK_IMPORTED_MODULE_4__, queries__WEBPACK_IMPORTED_MODULE_6__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
const schema = {
    POST: yup__WEBPACK_IMPORTED_MODULE_7__.object().shape({
        username: yup__WEBPACK_IMPORTED_MODULE_7__.string().required(),
        password: yup__WEBPACK_IMPORTED_MODULE_7__.string().required()
    })
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (async (req, res)=>{
    if (process.env.DISABLE_LOGIN) {
        return (0,next_basics__WEBPACK_IMPORTED_MODULE_5__.forbidden)(res);
    }
    req.yup = schema;
    await (0,lib_middleware__WEBPACK_IMPORTED_MODULE_4__/* .useValidate */ ._w)(req, res);
    if (req.method === "POST") {
        const { username, password } = req.body;
        const user = await (0,queries__WEBPACK_IMPORTED_MODULE_6__/* .getUserByUsername */ .dQ)(username, {
            includePassword: true
        });
        if (user && (0,next_basics__WEBPACK_IMPORTED_MODULE_5__.checkPassword)(password, user.password)) {
            if ((_umami_redis_client__WEBPACK_IMPORTED_MODULE_0___default().enabled)) {
                const token = await (0,lib_auth__WEBPACK_IMPORTED_MODULE_2__/* .setAuthKey */ .E0)(user);
                return (0,next_basics__WEBPACK_IMPORTED_MODULE_5__.ok)(res, {
                    token,
                    user
                });
            }
            const token = (0,next_basics__WEBPACK_IMPORTED_MODULE_5__.createSecureToken)({
                userId: user.id
        ...
        return (0,next_basics__WEBPACK_IMPORTED_MODULE_5__.unauthorized)(res, "message.incorrect-username-password");
    }
...
var __webpack_exports__ = __webpack_require__.X(0, [172,5510,4531], () => (__webpack_exec__(6983)));
