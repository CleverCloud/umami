...
/* harmony import */ var private_next_pages_api_teams_index_ts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(14105);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([private_next_pages_api_teams_index_ts__WEBPACK_IMPORTED_MODULE_3__]);
private_next_pages_api_teams_index_ts__WEBPACK_IMPORTED_MODULE_3__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__)[0];
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,next_dist_build_webpack_loaders_next_route_loader_helpers__WEBPACK_IMPORTED_MODULE_2__/* .hoist */ .l)(private_next_pages_api_teams_index_ts__WEBPACK_IMPORTED_MODULE_3__, "default"));
// Re-export config.
const config = (0,next_dist_build_webpack_loaders_next_route_loader_helpers__WEBPACK_IMPORTED_MODULE_2__/* .hoist */ .l)(private_next_pages_api_teams_index_ts__WEBPACK_IMPORTED_MODULE_3__, "config");
...
const routeModule = new PagesAPIRouteModule({
    ...
    userland: private_next_pages_api_teams_index_ts__WEBPACK_IMPORTED_MODULE_3__
});
...
/* harmony import */ var lib_yup__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(87789);
...
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([lib_auth__WEBPACK_IMPORTED_MODULE_0__, lib_crypto__WEBPACK_IMPORTED_MODULE_1__, lib_middleware__WEBPACK_IMPORTED_MODULE_2__, queries__WEBPACK_IMPORTED_MODULE_5__]);
([lib_auth__WEBPACK_IMPORTED_MODULE_0__, lib_crypto__WEBPACK_IMPORTED_MODULE_1__, lib_middleware__WEBPACK_IMPORTED_MODULE_2__, queries__WEBPACK_IMPORTED_MODULE_5__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
const schema = {
    GET: yup__WEBPACK_IMPORTED_MODULE_6__.object().shape({
        ...(0,lib_yup__WEBPACK_IMPORTED_MODULE_3__/* .getFilterValidation */ .W)(/All|Name|Owner/i)
    }),
    POST: yup__WEBPACK_IMPORTED_MODULE_6__.object().shape({
        name: yup__WEBPACK_IMPORTED_MODULE_6__.string().max(50).required()
    })
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (async (req, res)=>{
    ...
    if (req.method === "GET") {
        ...
        const results = await (0,queries__WEBPACK_IMPORTED_MODULE_5__/* .getTeamsByUserId */ .t3)(userId, {
            page,
            filter,
            pageSize: +pageSize || null
        });
        return (0,next_basics__WEBPACK_IMPORTED_MODULE_4__.ok)(res, results);
    }
    if (req.method === "POST") {
        if (!await (0,lib_auth__WEBPACK_IMPORTED_MODULE_0__/* .canCreateTeam */ .Xq)(req.auth)) {
            return (0,next_basics__WEBPACK_IMPORTED_MODULE_4__.unauthorized)(res);
        }
        const { name } = req.body;
        const team = await (0,queries__WEBPACK_IMPORTED_MODULE_5__/* .createTeam */ .Cm)({
            id: (0,lib_crypto__WEBPACK_IMPORTED_MODULE_1__/* .uuid */ .Vj)(),
            name,
            accessCode: (0,next_basics__WEBPACK_IMPORTED_MODULE_4__.getRandomChars)(16)
        }, userId);
        return (0,next_basics__WEBPACK_IMPORTED_MODULE_4__.ok)(res, team);
    }
    return (0,next_basics__WEBPACK_IMPORTED_MODULE_4__.methodNotAllowed)(res);
});
...
var __webpack_exports__ = __webpack_require__.X(0, [172,5510,4531], () => (__webpack_exec__(45338)));
