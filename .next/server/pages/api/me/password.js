...
/* harmony import */ var private_next_pages_api_me_password_ts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(50093);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([private_next_pages_api_me_password_ts__WEBPACK_IMPORTED_MODULE_3__]);
private_next_pages_api_me_password_ts__WEBPACK_IMPORTED_MODULE_3__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__)[0];
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,next_dist_build_webpack_loaders_next_route_loader_helpers__WEBPACK_IMPORTED_MODULE_2__/* .hoist */ .l)(private_next_pages_api_me_password_ts__WEBPACK_IMPORTED_MODULE_3__, "default"));
// Re-export config.
const config = (0,next_dist_build_webpack_loaders_next_route_loader_helpers__WEBPACK_IMPORTED_MODULE_2__/* .hoist */ .l)(private_next_pages_api_me_password_ts__WEBPACK_IMPORTED_MODULE_3__, "config");
// Create and export the route module that will be consumed.
const routeModule = new PagesAPIRouteModule({
    definition: {
        kind: next_dist_server_future_route_kind__WEBPACK_IMPORTED_MODULE_1__/* .RouteKind */ .x.PAGES_API,
        page: "/api/me/password",
        pathname: "/api/me/password",
        // The following aren't used in production.
        bundlePath: "",
        filename: ""
    },
    userland: private_next_pages_api_me_password_ts__WEBPACK_IMPORTED_MODULE_3__
});
...
/* harmony import */ var queries__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(37451);
/* harmony import */ var yup__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(75609);
/* harmony import */ var yup__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(yup__WEBPACK_IMPORTED_MODULE_3__);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([lib_middleware__WEBPACK_IMPORTED_MODULE_0__, queries__WEBPACK_IMPORTED_MODULE_2__]);
([lib_middleware__WEBPACK_IMPORTED_MODULE_0__, queries__WEBPACK_IMPORTED_MODULE_2__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);




const schema = {
    POST: yup__WEBPACK_IMPORTED_MODULE_3__.object().shape({
        currentPassword: yup__WEBPACK_IMPORTED_MODULE_3__.string().required(),
        newPassword: yup__WEBPACK_IMPORTED_MODULE_3__.string().min(8).required()
    })
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (async (req, res)=>{
    if (process.env.CLOUD_MODE) {
        return (0,next_basics__WEBPACK_IMPORTED_MODULE_1__.forbidden)(res);
    }
    ...
    if (req.method === "POST") {
        const user = await (0,queries__WEBPACK_IMPORTED_MODULE_2__/* .getUserById */ .GA)(id, {
            includePassword: true
        });
        if (!(0,next_basics__WEBPACK_IMPORTED_MODULE_1__.checkPassword)(currentPassword, user.password)) {
            return (0,next_basics__WEBPACK_IMPORTED_MODULE_1__.badRequest)(res, "Current password is incorrect");
        }
        const password = (0,next_basics__WEBPACK_IMPORTED_MODULE_1__.hashPassword)(newPassword);
        const updated = await (0,queries__WEBPACK_IMPORTED_MODULE_2__/* .updateUser */ .Nq)({
            password
        }, {
            id
        });
        return (0,next_basics__WEBPACK_IMPORTED_MODULE_1__.ok)(res, updated);
    }
...
var __webpack_exports__ = __webpack_require__.X(0, [172,5510,4531], () => (__webpack_exec__(47095)));
