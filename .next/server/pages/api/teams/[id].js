...
/* harmony import */ var private_next_pages_api_teams_id_index_ts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(7988);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([private_next_pages_api_teams_id_index_ts__WEBPACK_IMPORTED_MODULE_3__]);
private_next_pages_api_teams_id_index_ts__WEBPACK_IMPORTED_MODULE_3__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__)[0];
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,next_dist_build_webpack_loaders_next_route_loader_helpers__WEBPACK_IMPORTED_MODULE_2__/* .hoist */ .l)(private_next_pages_api_teams_id_index_ts__WEBPACK_IMPORTED_MODULE_3__, "default"));
// Re-export config.
const config = (0,next_dist_build_webpack_loaders_next_route_loader_helpers__WEBPACK_IMPORTED_MODULE_2__/* .hoist */ .l)(private_next_pages_api_teams_id_index_ts__WEBPACK_IMPORTED_MODULE_3__, "config");
...
const routeModule = new PagesAPIRouteModule({
    ...
    userland: private_next_pages_api_teams_id_index_ts__WEBPACK_IMPORTED_MODULE_3__
});
...
const schema = {
    ...
    POST: yup__WEBPACK_IMPORTED_MODULE_4__.object().shape({
        id: yup__WEBPACK_IMPORTED_MODULE_4__.string().uuid().required(),
        name: yup__WEBPACK_IMPORTED_MODULE_4__.string().max(50).required(),
        accessCode: yup__WEBPACK_IMPORTED_MODULE_4__.string().max(50).required()
    }),
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (async (req, res)=>{
    ...
    if (req.method === "GET") {
        ...
        const user = await (0,queries__WEBPACK_IMPORTED_MODULE_3__/* .getTeamById */ .mW)(teamId, {
            includeTeamUser: true
        });
        return (0,next_basics__WEBPACK_IMPORTED_MODULE_2__.ok)(res, user);
    }
    if (req.method === "POST") {
        if (!await (0,lib_auth__WEBPACK_IMPORTED_MODULE_0__/* .canUpdateTeam */ .bu)(req.auth, teamId)) {
            return (0,next_basics__WEBPACK_IMPORTED_MODULE_2__.unauthorized)(res, "You must be the owner of this team.");
        }
        ...
        const updated = await (0,queries__WEBPACK_IMPORTED_MODULE_3__/* .updateTeam */ .fs)(teamId, data);
        return (0,next_basics__WEBPACK_IMPORTED_MODULE_2__.ok)(res, updated);
    }
    if (req.method === "DELETE") {
        if (!await (0,lib_auth__WEBPACK_IMPORTED_MODULE_0__/* .canDeleteTeam */ .te)(req.auth, teamId)) {
            return (0,next_basics__WEBPACK_IMPORTED_MODULE_2__.unauthorized)(res, "You must be the owner of this team.");
        }
        await (0,queries__WEBPACK_IMPORTED_MODULE_3__/* .deleteTeam */ .fC)(teamId);
...
var __webpack_exports__ = __webpack_require__.X(0, [172,5510,4531], () => (__webpack_exec__(55570)));
