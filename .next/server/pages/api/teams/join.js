...
/* harmony import */ var private_next_pages_api_teams_join_ts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(93307);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([private_next_pages_api_teams_join_ts__WEBPACK_IMPORTED_MODULE_3__]);
private_next_pages_api_teams_join_ts__WEBPACK_IMPORTED_MODULE_3__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__)[0];
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,next_dist_build_webpack_loaders_next_route_loader_helpers__WEBPACK_IMPORTED_MODULE_2__/* .hoist */ .l)(private_next_pages_api_teams_join_ts__WEBPACK_IMPORTED_MODULE_3__, "default"));
// Re-export config.
const config = (0,next_dist_build_webpack_loaders_next_route_loader_helpers__WEBPACK_IMPORTED_MODULE_2__/* .hoist */ .l)(private_next_pages_api_teams_join_ts__WEBPACK_IMPORTED_MODULE_3__, "config");
// Create and export the route module that will be consumed.
const routeModule = new PagesAPIRouteModule({
    definition: {
        kind: next_dist_server_future_route_kind__WEBPACK_IMPORTED_MODULE_1__/* .RouteKind */ .x.PAGES_API,
        page: "/api/teams/join",
        pathname: "/api/teams/join",
        // The following aren't used in production.
        bundlePath: "",
        filename: ""
    },
    userland: private_next_pages_api_teams_join_ts__WEBPACK_IMPORTED_MODULE_3__
});
...
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([lib_middleware__WEBPACK_IMPORTED_MODULE_1__, queries__WEBPACK_IMPORTED_MODULE_3__]);
([lib_middleware__WEBPACK_IMPORTED_MODULE_1__, queries__WEBPACK_IMPORTED_MODULE_3__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (async (req, res)=>{
    ...
    if (req.method === "POST") {
        ...
        const team = await (0,queries__WEBPACK_IMPORTED_MODULE_3__/* .getTeamByAccessCode */ .aS)(accessCode);
        if (!team) {
            return (0,next_basics__WEBPACK_IMPORTED_MODULE_2__.notFound)(res, "message.team-not-found");
        }
        const teamUser = await (0,queries__WEBPACK_IMPORTED_MODULE_3__/* .getTeamUser */ .PW)(team.id, req.auth.user.id);
        if (teamUser) {
            return (0,next_basics__WEBPACK_IMPORTED_MODULE_2__.methodNotAllowed)(res, "message.team-already-member");
        }
        await (0,queries__WEBPACK_IMPORTED_MODULE_3__/* .createTeamUser */ .r4)(req.auth.user.id, team.id, lib_constants__WEBPACK_IMPORTED_MODULE_0__/* .ROLES */ .K$.teamMember);
        return (0,next_basics__WEBPACK_IMPORTED_MODULE_2__.ok)(res, team);
    }
...
var __webpack_exports__ = __webpack_require__.X(0, [172,5510,4531], () => (__webpack_exec__(76467)));
